...
let RouterBuilder = class RouterBuilder {
    ...
    */
    add(routeKeyOrRoute, routeUrlOrSegmentBuilder, controllerAndActionSeparatedByDot, options) {
        ...
        const route = this._createRoute(false, undefined, url, { controller: controller, action: action }, namedParamsDefinition, routeLangs, extension);
    ...
    */
     ...
     * @return {RouterRouteCommon}
    */
    _createRoute(segment, parent, routeUrl, controllerAndAction, namedParamsDefinition, routeLangs, extension) {
        if (!segment) {
        ...
        const finalRoute = segment ? new _Segment2.default(paramNames) : new _Route2.default(controllerAndAction.controller, controllerAndAction.action, extension, paramNames);
