...
var Router = (function () {
  ...
  Router.prototype.addRoute = function (routeKey, route) {
  ...
  Router.prototype._addInternalRoute = function (routeKey, route) {
    this._routesMap.set(routeKey, route);
  };

  Router.prototype.find = function (path, lang) {
  ...
  Router.prototype._findRoute = function (routes, completePath, path, lang, namedParams) {
    var _this = this;
    var result;
  ...
  Router.prototype._createRoute = function (completePath, lang, route, match, groupCount, namedParams) {
    var group = 0;
  ...
  Router.prototype.createLink = function (lang, routeKey, params, extension, query, hash) {
    var _this2 = this;
